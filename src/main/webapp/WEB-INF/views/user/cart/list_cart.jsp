...
-->
	<div class="row">
		<div class="span12">
			...
			<div class="well well-small">
				<h1>
					Giỏ hàng <small class="pull-right"> ${ totalQuantityCart } Sản phẩm trong giỏ
						hàng </small>
				</h1>
				<hr class="soften" />
					...
					<tbody>
						<c:forEach var="item" items="${ cart }">
							<tr>
								...
								<td><button data-id="${ item.key }" class="btn btn-mini btn-danger edit-cart"
										type="button">
										<span class="icon-edit"></span>
									</button></td>
								<td><a href="<c:url value="/delete-cart/${ item.key }"/>"
	...
	<content tag="script"> <script>
		$(".edit-cart").on("click", function EditQuantityCart() {
			var id = $(this).data("id");
			var quantity = $("#quantity-cart-"+id).val();
			window.location = "edit-cart/" + id + "/" + quantity
		})
	</script> </content>
